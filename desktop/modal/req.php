...
include_file('desktop', 'jsonviewer', 'php', 'watchdog');
...
echo  '<a class="btn btn-success pull-right" target="autre" href="http://'.config::byKey('internalAddr') . '/plugins/watchdog/resources/data/'.$partieFichier.'"><i class="fa fa-upload"></i> Télécharger JSON</a>';
...
//window.alert(selectedDevice+"-"+selectedJSON);
	...
	$('#md_modal').load('index.php?v=d&plugin=watchdog&modal=req&id=watchdog&json='+selectedJSON+'&device='+selectedDevice).dialog('open');
